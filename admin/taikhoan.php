                ...
                <tr class="bg-white border-b dark:bg-slate-800 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600">
                    ...
                    <td class="px-6 py-4"><?php echo $row['email']; ?></td>
                     <td class="px-6 py-4">
                        ...
                        <a href="taikhoan_xoa.php?tendangnhap=<?php echo $row['tendangnhap']; ?>" class="font-medium text-red-600 dark:text-red-400 hover:underline ml-4" onclick="return confirm('Bạn có chắc chắn muốn xóa tài khoản này?');">Xóa</a>
                    </td>
                </tr>
                <?php } ?>   
